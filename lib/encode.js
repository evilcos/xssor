...
knownxss.encode = {};
knownxss.encode._escape = function(){_g('Ww_B_0_textarea').value=escape(_g('Ww_B_0_textarea').value);}
knownxss.encode._unescape = function(){_g('Ww_B_0_textarea').value=unescape(_g('Ww_B_0_textarea').value);}
knownxss.encode._encodeURI = function(){_g('Ww_B_0_textarea').value=encodeURI(_g('Ww_B_0_textarea').value);}
knownxss.encode._decodeURI = function(){_g('Ww_B_0_textarea').value=decodeURI(_g('Ww_B_0_textarea').value);}
knownxss.encode.en = function(x){
	...
	for(i=0;i<txt.length;i++){
		...
		else if(_g('rwb_b1_c4').checked) {if(i<txt.length-1)_a+= txt.charCodeAt(i)+",";else{_a+= txt.charCodeAt(i)+",";_a="cos:expression(eval(String.fromCharCode(105,102,40,33,119,105,110,100,111,119,46,120,41,123,"+_a+"59,119,105,110,100,111,119,46,120,61,49,59,125)))";}}
	...
	for(i=0;i<txt.length;i++){
		...
		else _a+="\\u"+new Array(5-String(s).length).join("0")+s;}_g('Ww_B_0_textarea').value=_a;}
}
...
knownxss.encode.copy_ok = function(){_g('Ww_B_0_textarea').style.background='#DDDDDD';setTimeout("_g('Ww_B_0_textarea').style.background='#FFFFFF'",700);}
